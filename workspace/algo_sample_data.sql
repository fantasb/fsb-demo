...
('language_skills', 'Language Skills', 'Fluency of contemporary communication skills.<br /><em>Ex: Fluent in English</em>', 2, 1, 0, @now, @now),
('role_skill_fundamentals', 'Role Skill Fundamentals', 'Experience with technologies, applications, etc common to the Role.<br /><em>Ex: Swift, XCode</em>', 40, 1, 0, @now, @now),
('role_experience', 'Role Experience', 'Measure of time working directly within the Role.<br /><em>Ex: Years spent working as an iOS Developer</em>', 15, 1, 0, @now, @now),
('misc_role_facts', 'Misc Role Facts', 'Miscellaneous personal attributes or achievements relevant to the Role.<br /><em>Ex: Apps in App Store</em>', 15, 1, 0, @now, @now),
('basic_education', 'Basic Education', 'Has earned a Bachelor\'s degree or Role equivalent', 0, 0, 0, @now, @now),
('role_education', 'Role Education', 'Further education specific to the Role.<br /><em>Ex: BS in Computer Science</em>', 5, 1, 0, @now, @now),
('current_company', 'Current Company', 'Currently works at a company well respected for their work in the Role.<br /><em>Ex: Currently works for [insert iOS App]</em>', 5, 1, 100, @now, @now),
('previous_companies', 'Previous Companies', 'Previous work history implies experience within Role.<br /><em>Ex: Previously worked for [insert iOS App]</em>', 10, 1, 102, @now, @now),
('executives', 'Current Executive', 'Has worked with top-ranktted executives in relation to the Role', 0, 0, 0, @now, @now),
('venture_funded', 'Venture-Funded Experience', 'Intimate with startup work culture', 25, 1, 900, @now, @now),
('misc_company_facts', 'Misc Company Facts', 'Triumphs working at top-ranktted companies.<br /><em>Ex: Worked for company listed in BuiltInLA\'s Top 100 Tech Companies</em>', 5, 1, 101, @now, @now)
;
